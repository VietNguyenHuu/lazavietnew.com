...
class page_separater {
    ...
    public function process($total_item, $recent_page, $item_per_page, $option_link = Array('class_name' => 'page_seperator_item', 'strlink' => '#[[pagenumber]]')) {
        ...
        $this->_start = max(($this->_recent_page - 1) * $this->_item_per_page, 0);
        ...
        //Thêm mười chục trang xung quanh chục trang hiện tại
        ...
        //Thêm mười trăm trang xung quanh trăm trang hiện tại
        ...
        //Thêm mười ngàn trang xung quanh ngàn trang hiện tại
