       ...
       $id_type=$this->input->post('id_type');
        ...
        else
        {
            if($title!=""&&$title!='undefined')
            {
                ...
                $refreshurl=$this->input->post('refreshurl');
                echo "<div class='stt_avaiable'>Đã chỉnh sửa bài viết.</div>";
                echo "<div class='align_center'><a href='".$refreshurl."'><span class='button padding'>Làm mới trang</span></a><span class='button red padding' onclick='uncaption()'>Đóng</span></div>";
            }
            else
            {
